...
urlpatterns = [
    ...
    path('groups/<pk>/update/host/', views.UpdateGroupAdminView.as_view(), name="group_host_update"),
    ...
    path('session/<pk>/admin/', views.UpdateSessionAdminView.as_view(), name="session_update_admin"),
